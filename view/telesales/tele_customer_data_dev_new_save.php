...
if($rec_u = mysqli_query($condb,$sqlall)) {
    ...
    $sqldel = "DELETE FROM cc_ts_penawaran WHERE (customer_id='$txt_customer_no' OR customer_id_ro='$txt_customer_no');";
    $rec_i = mysqli_query($condb,$sqldel);

    $sqlinserttemp = "INSERT cc_ts_penawaran SELECT a.* FROM cc_ts_penawaran_temp_all a LEFT JOIN cc_ts_penawaran b
                      ON a.id=b.id WHERE (a.customer_id='$txt_customer_no' OR a.customer_id_ro='$txt_customer_no') ;";
    $rec_i = mysqli_query($condb,$sqlinserttemp);
